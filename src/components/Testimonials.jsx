...
const testimonials = [
  {
    ...
    text: 'The architectural precision and commitment to luxury standards was evident in every phase of our corporate headquarters project.',
    rating: 5
  },
  {
    name: 'Sarah Jenkins',
    ...
    text: 'They transformed my vision of a modern coastal villa into a masterpiece of glass and light. Truly a boutique experience.',
    rating: 5
  },
  {
    name: 'Michael Chen',
    role: 'MD, Skyview Plaza',
    image: 'https://i.pravatar.cc/150?u=michael',
    text: 'Professionalism at the highest level. Their team understands the complexities of high-end structural engineering.',
    rating: 5
  }
];
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-5xl mx-auto relative h-[450px]">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="glass-luxury p-12 md:p-20 rounded-[4rem] text-center relative border-white/60 shadow-2xl">
