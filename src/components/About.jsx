        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="relative pb-8 sm:pb-0">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 right-2 sm:-bottom-10 sm:-right-10 glass-luxury p-6 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] z-20 max-w-[200px] sm:max-w-xs shadow-2xl"
            >
              <div className="text-2xl sm:text-4xl font-black text-luxury-gold mb-2 tracking-tighter">98%</div>
